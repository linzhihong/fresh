window.System = {
	init:function(){
		...
		BasePath = BasePath.substring(0,BasePath.indexOf('component/component.js'));
		...
		//			}
			...
			for(var j = 0 ; j < jslistlazy.length ; j++){
				if(jslistlazy[j]!=''){
					...
					noImportantJs.push('<script type="text/javascript" src="'+url+'"></script>');
				}
			}
			...
			for(var c = 0 ; c < csslistlazy.length ; c++){
				if(csslistlazy[c]!=''){
					...
					noImportantCss.push('<link href="'+url+'" rel="stylesheet" type="text/css" >');
				}
			}
	//	}else{
	//		function lj(j){
...
//								}
								...
								function rd(){
									$('body').append(window.noImportantJs.join('')+window.noImportantCss.join(''));
...
//										System.readyFuns[i]();
//									}
									window.deceleration = mui.os.ios?0.003:0.0006//阻尼系数
									...
									if(window.mui){
										...
										mui(document).on('tap','.mui-scroll-wrapper [onclick]',function(e){
											System.stopBubble(e);
											document.activeElement.blur();
											//this.click();
											this.el = {};
										...
										mui(document).on('tap','.mui-scroll-wrapper [tapClick]',function(e){
											System.stopBubble(e);
											document.activeElement.blur();
											var self = $(this);
